...
export const quizQuestions: QuizQuestion[] = [
  // SECTION 1: ABOUT THEM
  {
    ...
    maxSelect: 1,
    options: [
      { label: "A heartfelt note or sweet message", styles: ["Soft & Sentimental"] },
      { label: "Something useful they actually need", styles: ["Thoughtful & Practical"] },
      { label: "Something to make them relax and rest", styles: ["Comfort & Care"] },
      { label: "Something stylish they can show off", styles: ["Stylish & Aesthetic"] },
      { label: "A surprise outing or adventure", styles: ["Experiential & Immersive"] },
    ],
  },
  {
    id: 2,
    section: "About Them",
    question: "When {name} opens a gift, what typically makes them go \"Oh wow\"?",
    type: "choice",
    maxSelect: 2,
    options: [
  ...
  },
  {
    ...
    maxSelect: 2,
    options: [
      { label: "Words of reassurance and emotional support", styles: ["Soft & Sentimental"] },
      { label: "Someone handling things for them", styles: ["Thoughtful & Practical"] },
      { label: "Good food, rest, or pampering", styles: ["Comfort & Care"] },
      { label: "Retail therapy or a fresh look", styles: ["Stylish & Aesthetic"] },
      { label: "A fun distraction or spontaneous plan", styles: ["Experiential & Immersive"] },
    ],
  },
  ...
  },
  {
    id: 5,
    section: "How They Experience Gifts",
    question: "If you could do or gift ONE THING to {name} that will remain unforgettable to them for a long time, what would that be?",
    type: "choice",
    maxSelect: 1,
    options: [
      { label: "Write them something from your heart", styles: ["Soft & Sentimental"] },
      { label: "Gift them something personalized", styles: ["Thoughtful & Practical"] },
      { label: "Take care of something stressing them out", styles: ["Comfort & Care"] },
      { label: "Surprise them with something they'll like to show off", styles: ["Stylish & Aesthetic"] },
  ...
  // SECTION 3: YOU
  {
    id: 6,
    section: "You",
    question: "How involved do you want to be in creating this gift for {name}?",
    type: "choice",
    maxSelect: 1,
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "I want something simple but deeply meaningful", styles: ["Soft & Sentimental", "Comfort & Care"] },
    ],
  },
  {
    id: 8,
